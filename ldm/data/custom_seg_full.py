...
class SegmentationBase(Dataset):
    ...
    def __getitem__(self, i):
        ...
        # Return both images in the form of a dictionary to match the 'cond' input of apply_model
        return {'image': processed_rgb['image'], 'segmentation': processed_seg['image']}

class CustomSegTrain(SegmentationBase):
    def __init__(self, size=256, random_crop=False, interpolation="bilinear"):
        super().__init__(rgb_txt='/home/remote/u7177316/dataset/smoke5k/train/img/train_img.txt',
                         seg_txt='/home/remote/u7177316/dataset/smoke5k/train/gt/train_gt.txt',
                         size=size, random_crop=random_crop, interpolation=interpolation)

class CustomSegEval(SegmentationBase):
    def __init__(self, size=256, random_crop=False, interpolation="bilinear"):
        super().__init__(rgb_txt='/home/remote/u7177316/dataset/smoke5k/test/img/test_img.txt',
                         seg_txt='/home/remote/u7177316/dataset/smoke5k/test/gt/test_gt.txt',
                         size=size, random_crop=random_crop, interpolation=interpolation)
